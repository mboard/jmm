...
public class MenuEventController {
    ...
    public static void open(final Context context, final RelativeLayout layout,final LinearLayout layout2, final TextView name){
    ...
    public static void close(final Context context, final RelativeLayout layout, final LinearLayout layout2, final TextView name){
    ...
    public static ArrayList<HashMap<String, Object>> getMenuDefault(final Context context){
		...
		for(int i = 0; i < listItemMenu.size(); i++){
			...
			map.put(GROUP, listItemMenu.get(i).getGroup());
